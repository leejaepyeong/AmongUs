...
public class MinimapUI : MonoBehaviour
{
    ...
    [SerializeField]
    private Image minimapPlayerImg;
    ...
    void Start()
    {
        var inst = Instantiate(minimapImg.material);
        minimapImg.material = inst;
    ...
    void Update()
    {
        if(targetPlayer != null)
        {
            ...
            minimapPlayerImg.rectTransform.anchoredPosition = new Vector2(minimapImg.rectTransform.sizeDelta.x * normalPos.x, minimapImg.rectTransform.sizeDelta.y * normalPos.y);
